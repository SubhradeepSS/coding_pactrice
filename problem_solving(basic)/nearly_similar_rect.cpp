/* 
rects of sides [a, b] and [c, d] nearly similar if a/b == c/d.
Q: find such pairs of rectangles from the given list of rectangles
*/
...
long nearlySimilarRectangles(vector<vector<long>> sides) {
   for(int i=0; i<sides.size(); i++){
       long gcd = __gcd(sides[i][0], sides[i][1]);
       sides[i][0] /= gcd;
       sides[i][1] /= gcd;
   } 
